module internal ResponsesParser
...
module private Impl =
  ...
  let mapToParsedReqRep (partialReqRep: PartialReqRep) : ParsedReqRep =
  ...
  let (|RequestWithBodyAndHeaders|RequestWithBody|RequestWithHeaders|Request|) (parsedReqRep: ParsedReqRep) =
  ...
  let mapToResponse parsedReqRep =
    match parsedReqRep with
...
let parse = Impl.parse
let mapToResponse = Impl.mapToResponse
